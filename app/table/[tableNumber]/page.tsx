...
export default function CustomerTableOrderingPage({ params }: TablePageProps) {
  ...
  const [storeInfo, setStoreInfo] = useState<{
    ...
    name: "ScanSip Cafe & Roastery",
    promptPayNumber: "089-999-8888",
    openingTime: "07:30",
    closingTime: "19:00",
  });
  ...
  // Load Store Info, Categories, and Menu Items from live database
    ...
    const interval = setInterval(async () => {
      try {
        ...
        if (json.success && json.data) {
          const current = json.data.find((o: CreatedOrder) => o.id === activeOrder.id);
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-[#191c1d] pb-28">
      ...
      {/* Floating Bottom Cart Bar (แถบตะกร้าด้านล่าง) */}
